...
alias mitx="cd ~/work/mitx/apps"
alias mitxsrv="cd ~/work/mitx/apps/xbooker-general-server"
alias mitxweb="cd ~/work/mitx/apps/xbooker-general-web"
alias mitxagent="cd ~/work/mitx/apps/x-agent"
alias mitxforms="cd ~/work/mitx/apps/xforms-frontend"
